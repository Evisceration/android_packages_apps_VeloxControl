...
public class IntSeekBarPreference extends Preference
    ...
    public IntSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected View onCreateView(ViewGroup parent) {
        ...
        int progress;
        try {
            progress = Settings.System.getInt(getContext().getContentResolver(), property);
        } catch (Exception e) {
