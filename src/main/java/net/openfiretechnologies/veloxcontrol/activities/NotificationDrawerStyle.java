...
import net.openfiretechnologies.veloxcontrol.widgets.SeekBarPreference;

import java.io.File;
import java.io.FileOutputStream;

public class NotificationDrawerStyle extends PreferenceActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        customnavTemp = new File(getFilesDir() + "/notification_wallpaper_temp.jpg");
        customnavTempLandscape = new File(getFilesDir() + "/notification_wallpaper_temp_landscape.jpg");
    ...
    public void deleteWallpaper(boolean orientation) {
        File wallpaperToDelete = new File(getFilesDir() + "/notification_wallpaper.jpg");
        File wallpaperToDeleteLandscape = new File(getFilesDir() + "/notification_wallpaper_landscape.jpg");
