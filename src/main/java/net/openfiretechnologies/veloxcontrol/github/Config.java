...
public class Config {
    ...
    public static final String ORGANIZATION = "Evisceration/";
    public final String REPO_URL = GITHUB_JSON + "users/" + ORGANIZATION + "repos";
    ...
    public final String CHANGELOG_JSON = "https://raw.github.com/Evisceration/android_vendor_velox/alex/versioninfo/CHANGELOG-VELOX.txt";
}
