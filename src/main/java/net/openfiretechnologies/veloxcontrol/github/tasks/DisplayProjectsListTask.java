...
package net.openfiretechnologies.veloxcontrol.github.tasks;
...
import net.openfiretechnologies.veloxcontrol.github.CommitViewerDialog;
import net.openfiretechnologies.veloxcontrol.github.CommitsFragment;
import net.openfiretechnologies.veloxcontrol.github.Config;
import net.openfiretechnologies.veloxcontrol.github.FavPackagesStorage;
...
public class DisplayProjectsListTask extends AsyncTask<Void, Void, Void> {
    ...
    protected void onPostExecute(Void unused) {
        for (JSONArray aMPrefsList : mPrefsList) {
            loadProjectsToArray(aMPrefsList);
        }
